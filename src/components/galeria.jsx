...
useEffect( ()=> {
  async function  fetchImagenes(){
    ...
    .from("Imagenes" )
    .select("id,file_path,captured_at,description,created_at")

     if (error) {
        console.log("Error al obtener las imagenes de la galeria :", error);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        {imagenes.map((img) => (
          <div
            ...
            style={{ backgroundImage: `url(${img.file_path})` }}
          >
